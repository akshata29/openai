...
def sample_abstractive_summarization() -> None:
    ...
    from azure.ai.textanalytics import AbstractSummaryAction, AbstractiveSummary

    endpoint = "2540afb1398c40af8fa8078ea1735556"
    key = "https://eastus.api.cognitive.microsoft.com/"
